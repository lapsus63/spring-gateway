...
public class KodiConfig {
    ...
    public final static JSONArray PAYLOAD_PARTY_MODE = new JSONArray(List.of(new JSONObject(Map.of("jsonrpc", "2.0", "id", 1,
            "method", "Player.SetPartyMode", "params", new JSONObject(Map.of("playerid", 0, "partymode", true))))));
    ...
    public final static JSONArray PAYLOAD_VOL_UP = new JSONArray(List.of(new JSONObject(Map.of("jsonrpc", "2.0", "id", 1,
            "method", "Application.SetVolume", "params", new JSONObject(Map.of("volume", "increment"))))));

    public final static JSONArray PAYLOAD_VOL_DOWN = new JSONArray(List.of(new JSONObject(Map.of("jsonrpc", "2.0", "id", 1,
            "method", "Application.SetVolume", "params", new JSONObject(Map.of("volume", "decrement"))))));


    public final static JSONArray PAYLOAD_RADIO_CAMPUS = new JSONArray(List.of(new JSONObject(Map.of("jsonrpc", "2.0", "id", 1,
            "method", "Player.Open", "params", new JSONObject(Map.of("item", new JSONObject(Map.of("file", "https://live.radio-campus.org:8002/clermont-ferrand"))))))));

    public final static JSONArray PAYLOAD_RADIO_NOVA = new JSONArray(List.of(new JSONObject(Map.of("jsonrpc", "2.0", "id", 1,
            "method", "Player.Open", "params", new JSONObject(Map.of("item", new JSONObject(Map.of("file", "https://novazz.ice.infomaniak.ch/novazz-128.mp3"))))))));

    public final static JSONArray PAYLOAD_RADIO_CLASSIQUE = new JSONArray(List.of(new JSONObject(Map.of("jsonrpc", "2.0", "id", 1,
            "method", "Player.Open", "params", new JSONObject(Map.of("item", new JSONObject(Map.of("file", "https://novazzradioclassique.ice.infomaniak.ch/radioclassique-high.mp3"))))))));

    public final static JSONArray PAYLOAD_RADIO_FRANCE_INTER = new JSONArray(List.of(new JSONObject(Map.of("jsonrpc", "2.0", "id", 1,
            "method", "Player.Open", "params", new JSONObject(Map.of("item", new JSONObject(Map.of("file", "http://direct.franceinter.fr/live/franceinter-midfi.mp3"))))))));
